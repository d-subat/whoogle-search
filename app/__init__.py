...
app.config['CSP'] = 'default-src \'self\' \'unsafe-inline\' http://aggl.herokuapp.com https://aggl.herokuapp.com ;' \
                    'frame-src ' + translate_url + ';' \
                    'manifest-src \'self\';' \
                    'img-src \'self\' data:;' \
                    'font-src \'self\' \'unsafe-inline\' http://aggl.herokuapp.com https://aggl.herokuapp.com;' \
